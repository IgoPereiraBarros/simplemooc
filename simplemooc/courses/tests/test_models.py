...
class CourseManagerTestCase(TestCase):
	...
	def setUp(self):
		self.courses_django = mommy.make(
			'courses.Course', name='Python com django', _quantity=5
		)
		self.courses_data = mommy.make(
			'courses.Course', name='Python para data science', _quantity=10
		)
		self.client = Client()
	...
	def test_course_search(self):
		...
		search = Course.objects.search('science')
